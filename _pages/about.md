...
Right now, I enjoy conducting research on topics some sort connected with deep learning, high dimensional probability, and trustworthy machine learning.

As an example, I like to think if over-parameterized models hide some not-necessarily-trivial behavior, with maybe some implications connected to privacy or robustness.
